!(function (e, t) {
        ...
        ((Observer.prototype.init = function init(e) {
            ...
            function Se() {
                ...
                T && (r || n) && T(se, e, t, be, me),
                    r && (m && 0 < se.deltaX && m(se), y && se.deltaX < 0 && y(se), S && S(se), k && se.deltaX < 0 != le < 0 && k(se), (le = se.deltaX), (be[0] = be[1] = be[2] = 0)),
                    n && (w && 0 < se.deltaY && w(se), x && se.deltaY < 0 && x(se), _ && _(se), C && se.deltaY < 0 != ce < 0 && C(se), (ce = se.deltaY), (me[0] = me[1] = me[2] = 0)),
    ...
    function Cb() {
        T.cache++, rt || g || Je.fullscreenElement || Je.webkitFullscreenElement || (v && m === je.innerWidth && !(Math.abs(je.innerHeight - b) > 0.25 * je.innerHeight)) || l.restart(!0);
    }
    function Ib(e) {
        var t,
            r = We.ticker.frame,
    ...
    var We,
        ...
        Mt = function _getBounds(e, t) {
            var r = t && "matrix(1, 0, 0, 1, 0, 0)" !== db(e)[u] && We.to(e, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1),
            ...
            ((ScrollTrigger.prototype.init = function init(_, T) {
                    ...
                    if (
                        ((Se.media = lt),
                            ...
                            ((Ka(ce) && !ce.push) || (ce = { snapTo: ce }),
                                "scrollBehavior" in Ge.style && We.set(be ? [Ge, qe] : ve, { scrollBehavior: "auto" }),
                                (p = Ia(ce.snapTo)
                                    ? ce.snapTo
                                    : "labels" === ce.snapTo
                            ...
                            ie &&
                            (!1 === oe || oe === _t || (oe = !(!oe && "flex" === db(ie.parentNode).display) && St),
                                (Se.pin = ie),
                                !1 !== _.force3D && We.set(ie, { force3D: !0 }),
                                (n = We.core.getCache(ie)).spacer
                                    ? (Y = n.pinState)
                                    : (l && ((l = I(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = ac(l))),
                    ...
                    (Se.previous = function () {
                        ...
                        (Se.revert = function (e) {
                            var t = !1 !== e || !Se.enabled,
                                r = rt;
                            t !== Se.isReverted &&
                                (t && (!Se.scroll.rec && rt && ct && (Se.scroll.rec = Ce()), (q = Math.max(Ce(), Se.scroll.rec || 0)), (Q = Se.progress), (G = T && T.progress())),
                                    P &&
                        ...
                        (Se.refresh = function (e, t) {
                            if ((!rt && Se.enabled) || t)
                                if (ie && e && pt) nb(ScrollTrigger, "scrollEnd", Jb);
                                    ...
                                    !ct && _e && _e(Se), (rt = 1), (Ae = dt()), k.tween && (k.tween.kill(), (k.tween = 0)), W && W.pause(), ae && T && T.time(-0.01, !0).invalidate(), Se.isReverted || Se.revert();
                                    for (
                                        var r,
                                        n,
                                        i,
                                    ...
                                    for (
                                        ...
                                        Ia(b) && (b = b(Se)),
                                        Ha(b) && !b.indexOf("+=") && (~b.indexOf(" ") ? (b = (Ha(y) ? y.split(" ")[0] : "") + b) : ((h = tb(b.substr(2), d)), (b = Ha(y) ? y : C + h), (m = ne))),
                                        O = Math.max(C, dc(b || (m ? "100% 0" : g), m, d, ge, Ce() + h, E, D, Se, p, we, me, g, fe)) || -0.001,
                                        z = O - C || ((C -= 0.01) && 0.001),
                                        h = 0,
                                        S = w;
                                        S--;
                                    ...
                                    if (((C += h), (O += h), (Se._pinPush = v), P && h && (((r = {})[ge.a] = "+=" + h), x && (r[ge.p] = "-=" + Ce()), We.set([P, E], r)), ie))
                                        (r = db(ie)),
                                            (o = ge === Ne),
                                            (i = Ce()),
                                            ...
                                            (n = Mt(ie, !0)),
                                            (c = me && J(ve, o ? Re : Ne)()),
                                            oe && (((U = [oe + ge.os2, z + v + kt]).t = L), (S = oe === St ? hb(ie, ge) + z + v : 0) && U.push(ge.d, S + kt), It(U), me && Ce(q)),
                                            me &&
                                            (((a = { top: n.top + (o ? i - C : c) + kt, left: n.left + (o ? c : i - C) + kt, boxSizing: "border-box", position: "fixed" })[vt] = a.maxWidth = Math.ceil(n.width) + kt),
                                            ...
                                            T ? ((u = T._initted), at(1), T.render(T.duration(), !0, !0), (N = H(ge.a) - R + z + v), z !== N && me && X.splice(X.length - 2, 2), T.render(0, !0, !0), u || T.invalidate(), at(0)) : (N = z);
                                    else if (ne && Ce() && !fe) for (n = ne.parentNode; n && n !== Ge;) n._pinOffset && ((C -= n._pinOffset), (O -= n._pinOffset)), (n = n.parentNode);
                                    f &&
                                        ...
                                        (Q === Se.progress && !fe) || (T && !he && T.totalProgress(Q, !0), (Se.progress = Q), Se.update(0, 0, 1)),
                        ...
                        (Se.update = function (e, t, r) {
                            if (!fe || r || e) {
                                var n,
                                    ...
                                    p = Se.progress;
                                if (
                                    (t && ((A = M), (M = fe ? Ce() : u), ce && ((V = S), (S = T && !he ? T.totalProgress() : d))),
                                    ...
                                    if (
                                        ((a = (s = (n = Se.isActive = !!d && d < 1) != (!!p && p < 1)) || !!d != !!p),
                                            ...
                                            (Se.progress = d),
                                            a && !rt && ((i = d && !p ? 0 : 1 === d ? 1 : 1 === p ? 2 : 3), he && ((o = (!s && "none" !== xe[i + 1] && xe[i + 1]) || xe[i]), (c = T && ("complete" === o || "reset" === o || o in T)))),
                                            pe &&
                                            (s || c) &&
                                            (c || re || !T) &&
                                            (Ia(pe)
                                            ...
                                            (!W || rt || ft
                                                ...
                                                : ((fe || (ut && ut !== Se)) && W.render(W._dp._time - W._start), W.resetTo ? W.resetTo("totalProgress", d, T._tTime / T._tDur) : ((W.vars.totalProgress = d), W.invalidate().restart()))),
                                            ie)
                                    )
                                    ...
                                    !ce || k.tween || rt || ft || j.restart(!0),
                                        ...
                                        !Z || he || e || Z(Se),
                                        a && !rt
                                            ? (he && (c && ("complete" === o ? T.pause().totalProgress(1) : "reset" === o ? T.restart(!0).pause() : "restart" === o ? T.restart(!0) : T[o]()), Z && Z(Se)),
                                                (!s && st) || (ee && s && Oa(Se, ee), ye[i] && Oa(Se, ye[i]), le && (1 === d ? Se.kill(!1, 1) : (ye[i] = 0)), s || (ye[(i = 1 === d ? 1 : 3)] && Oa(Se, ye[i]))),
                                                de && !n && Math.abs(Se.getVelocity()) > (Ja(de) ? de : 2500) && (Na(Se.callbackAnimation), W ? W.progress(1) : Na(T, !d, 1)))
                                            : he && Z && !rt && Z(Se);
                                }
                                if (w) {
                        ...
                        (Se.enable = function (e, t) {
                            Se.enabled ||
                                ((Se.enabled = !0), nb(ve, "resize", Cb), nb(be ? Je : ve, "scroll", Ab), _e && nb(ScrollTrigger, "refreshInit", _e), !1 !== e && ((Se.progress = Q = 0), (M = A = Me = Ce())), !1 !== t && Se.refresh());
                        }),
                ...
                (ScrollTrigger.enable = function enable() {
                    if (
                        ((je = window),
                            ...
                            (Ge = Je.body),
                            We && ((Ke = We.utils.toArray), (et = We.utils.clamp), (at = We.core.suppressOverwrites || xa), We.core.globals("ScrollTrigger", ScrollTrigger), Ge))
                    ) {
                        (gt = 1),
                            k.register(We),
                ...
                (ScrollTrigger.config = function config(e) {
                    ...
                    (t && clearInterval(c)) || ((c = t) && setInterval(zb, t)),
                        ...
                        "autoRefreshEvents" in e && (Ga(ob) || Ga(nb, e.autoRefreshEvents || "none"), (g = -1 === (e.autoRefreshEvents + "").indexOf("resize")));
                }),
                    ...
                    for (r in e)
                        (n = U.indexOf(r)),
                            ...
                            "all" === (lt = r)
                                ...
                                : (t = je.matchMedia(r)) &&
                                (t.matches && (o = i()),
                                    ~n ? ((U[n + 1] = Ma(U[n + 1], i)), (U[n + 2] = Ma(U[n + 2], o))) : ((n = U.length), U.push(r, i, o), t.addListener ? t.addListener(Ib) : t.addEventListener("change", Ib)),
                                    (U[n + 3] = t.matches)),
                            (lt = 0);
                    return U;
                }),
    ...
    function qc(e) {
        ...
        return (
            ...
            (e.onRelease = e.onGestureStart = function (e, t) {
                if ((g && ((g.style.transform = "translateY(0px)"), (h.offset = h.cacheID = 0), g._gsap && (g._gsap.y = "0px")), t)) {
                    ...
                    var r,
                        n,
                        i = x();
                    f && ((n = (r = v()) + (0.05 * i * -e.velocityX) / 0.227), (i *= ic(v, r, n, Fa(d, Re))), (s.vars.scrollX = S(n))),
            ...
            (u = r._dc),
            (s = We.to(r, { ease: "power4", paused: !0, scrollX: f ? "+=0.1" : "+=0", scrollY: "+=0.1", onComplete: u.vars.onComplete })),
            r
        );
    }
    var ae,
